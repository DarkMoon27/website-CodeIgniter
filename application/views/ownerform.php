    		...
    		<div class="row">        
        		<div class="">
         			<div class="checkoutsteptitle"></div>
         				...
         				<h6 style="margin-left:40px; color:#880000 ; ">* isi kolom</h6>
                        	<div class="ownerdetails" id="owner" >
                            	<h3 class="heading3" style="margin-bottom:10px;">Detail Pemilik </h3><hr>
              						<div class="loginbox">
                  						<div >
                          					<div class="controls" style="margin-bottom:12px;">
                           						<input type="text" name="fname" value="" placeholder="*Nama Depan"  style="text-transform: capitalize;" pattern="[a-zA-Z]+" required> &nbsp;&nbsp;
                          			   			<input type="text" name="oname" value="" placeholder="*Nama Pemilik Perusahaan" style="text-transform: capitalize;" pattern="[a-zA-Z]+" required> 
                          					</div>
                        				</div>
                        				
                        				<div>
                  							<div class="controls" style="margin-bottom:12px;">
                                        	<input type="text" name="mno" value="" placeholder="*Nomor Telepon"  pattern="[\b(7\8\9)]\d{9,9}" required> &nbsp;&nbsp;
                                     	...
                                     	<div>
                  							<div class="controls" style="margin-bottom:12px;" >
                                        	<input type="text" name="sno" value="" placeholder="*toko/gudang/kantor no."  required> &nbsp;&nbsp;
                    					...
                    					<div>
                  							<div class="controls" style="margin-bottom:12px;"  >
                                        	<textarea placeholder="*Alamat Pemilik" name="address" style="width:50%;" required ></textarea>
                      						</div>
                    					</div>
               				 		</div>
            				</div>

        ...
        <div class="">
          ...
          <div class="checkoutstep ">
           <div class="newcustomer "  >
              <h3 class="heading3" style="margin-bottom:20px;">Detail Alamat </h3>
              <div class="loginbox">
                  <form class="form-vertical" action="<?php echo site_url('tv/addressinsert')?>" method="post">
                    ...
                    <div class="controls" style="margin-bottom:12px;" id="id1"  >
                     <input type="text" name="newd" value="" placeholder="Tambahkan distrik Anda"> 
                   ...
                   <div>
                    <div class="controls" style="margin-bottom:12px;" id="id2"  onclick="adddistrict()">
                     <input type="text" name="newp" value="" placeholder="Tambahkan kode PIN Anda"> 
                    ...
                    <br>
                    <input type="submit" Value="simpan" class="btn btn-orange">

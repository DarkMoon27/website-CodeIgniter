                            ...
                            <div class="navbar-inner">
                                <ul class="nav " >
                                    <li><div class=" top-search">
                                     ...
                                     <div>
                            			<ul>
                                			<li><a href="<?php echo site_url('tv/profile')?>" style="color:#800000">profil Anda</a> </li>
                                ...
                                <a class="myaccount" href="<?php echo base_url('tv/register')?>">Login/Register</a>
                                  ...
                                  {?>
                                     ...
                                     <div>
                            			<ul>
                                			<li><a href="<?php echo site_url('tv/shoppingcart')?>" style="color:#800000">Lihat keranjang</a> </li>
                                			<li><a href="<?php echo site_url('tv/wishlist')?>"style="color:#800000">Lihat barang yang diminati</a> </li>
                            			</ul>
                        			</div>
                                     </li>
                                     </ul>
                                       <?php }else {?> 
                                       <ul class=" nav categorymenu " >
                                     <li ><a class="shoppingcart" href="#">keranjang</a>
                                     <div>
                            			<ul>
                                		<div>Tolong login terlebih dahulu</div>

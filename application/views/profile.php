...
<div class="span8">
<div class="checkoutsteptitle"><h3><span class="maintext">Detail Profil</span></h3> <hr></div>
<div class="span5">
<?php foreach($data as $row){
$id=$row->user_id;?>
<table >

<tr><td class="profile"> <b>Nama-Depan :</b></td> <td><?php echo $row->fname?></td><tr>
<tr><td class="profile"> <b>Nama-Belakang :</b></td> <td><?php echo $row->lname?></td><tr>
<tr><td class="profile"> <b>Email :</b></td> <td><?php echo $row->email?></td><tr>
<tr><td class="profile"> <b>Nomor Telepon :</b></td> <td><?php echo   $row->contact_no?></td><tr>
<tr><td class="profile"><b> Alamat :</b></td> <td><?php echo  $row->address ?></td><tr>
</tr>
</table>
...
$address=$var->address;
	...
	<h3 style="margin-bottom:30px;">Edit Profil Anda</h3><hr></hr>
	
	<div >
                              <div class="controls" style="margin-bottom:6px;">
                              <div><b>NamaDepan:</b></div>
...
<h4 style="margin-bottom:30px;">Ubah Password Anda</h4><hr></hr>
	
	<form action="<?php echo site_url('tv/changepasswordquery/') ?>" method="post">
	
	<div>
                    <div class="controls" style="margin-bottom:6px;">
                  <div><b> Password baru:</b></div>
                    ...
                    <div>
                    <div class="controls" style="margin-bottom:6px;">
                  <div><b>  Ketik Ulang Password:</b></div>
...
<div class="span8" id="productstatus">
	<div class="checkoutsteptitle"><h3><span class="maintext">Detail produk yang diupload</span></h3> <hr>
	<table class="table table-striped table-bordered">
			<tr>
          
            <th class="image">Gambar Produk</th>
            <th class="name">Nama produk</th>
            <th class="model">Categori</th>
            <th class="quantity">sub-Categori</th>
            <th class="total">Tipe Produk</th>
...
<h1 class="heading1"><span class="maintext"> Riwayat Pembelian</span></h1>
      <!-- Cart-->
      <div class="cart-info">
        <table class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <th class="model">Nomor Model</th>
             <th class="quantity">Jumlah</th>
              <th class="model">Ukuran</th>
...
<h4 style="margin-bottom:30px;">Ubah Password Anda</h4><hr></hr>
	...
	<h1 class="heading1"><span class="maintext">  Pengguna BadaPurchase</span></h1>
      <!-- Cart-->
      <div class="cart-info">
      <form method="post" action="<?php echo site_url('tv/verifydeleteuser')?>">
        ...
        <tr>
         ...
         <input type="submit" name="deleteall" onclick="this.value=true" class="btn btn-orange"  style="width:45%; font-weight:bold;" value="Deactivate All" >
          ...
          <tr>
          <th class="name"><div>Pilih Semua</div><div><input type="checkbox" name="verify1[]" onchange="checkuser(this)"></div></th>
            <th class="image">Gambar Pengguna</th>
            <th class="name">Nama Pengguna</th>
            
            <th class="quantity">Nomor Telepon</th>
	...
	<h1 class="heading1"><span class="maintext"> Produk di BadaPurchase</span></h1>
      <!-- Cart-->
      <div class="cart-info">
      <form method="post" action="<?php echo site_url('tv/verifydelete')?>">
        ...
        <input type="submit" name="verifyall" onclick="this.value=true" class="btn btn-orange"  style="width:45%;margin-right:10%; font-weight:bold;" value="Verify" >
         <input type="submit" name="deleteall" onclick="this.value=true" class="btn btn-orange"  style="width:45%; font-weight:bold;" value="Deactivate" >
          ...
          <tr>
          <th class="name"><div>Pilih Semua</div><div><input type="checkbox" name="verify[]"  onchange="checkAll(this)" ></div></th>
            <th class="image">Gambar Produk</th>
            <th class="name">Nama Produk</th>
            <th class="model">Nomor Model</th>
            <th class="quantity">Harga</th>
            <th class="total">Action</th>

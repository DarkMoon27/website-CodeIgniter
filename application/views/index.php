<div id="maincontainer">
  ...
  <div class="container">
  <h1 class="heading1"><span class="maintext">Produk Terbaru</span><span class="subtext"> Lihat Produk Terbaru Kami</span></h1>
       ...
       <div> <a class="prdocutname" href="<?php echo site_url('tv/product/'.$pid)?>"><?php echo $productname ?></a></div>  
          <div class="thumbnail" >
            ...
            <div class="pricenew" style="margin-right:90px;"><?php echo "Rs " ;?><?php echo $productprice?></div>
             <a href="<?php echo site_url('tv/product/'.$pid)?>" class="" style="margin-right:63px;">Tambah Ke Keranjang</a>
  ...
  <section id="popularbrands" class="container mt40">
    <h1 class="heading1"><span class="maintext">Popular Brands</span><span class="subtext"> Lihat Brand Populer Kami</span></h1>
  ...
  <section id="newslettersignup" class="mt40">
    <div class="container">
      <div class="pull-left newsletter">
        ...
        Sign up untuk berita terbaru Kami & dapatkan penawaran menarik dengan berlangganan berita terbaru Kami. </div>
      <div class="pull-right">
        <form class="form-horizontal">
          <div class="input-prepend controls">
            <input type="text" placeholder="Berlangganan untuk berita terbaru" id="inputIcon" class="input-xlarge">
            <input value="Berlangganan" class="btn btn-orange" type="submit" style="height:33px;">
             </div>
        </form>
      </div>
    </div>

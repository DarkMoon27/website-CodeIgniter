    ...
    <div class="container">
      ...
      <div class="row">        
        ...
        <aside class="span2">
         ...
         <div class="span2 ">
          <div class="sidewidt">
            <h2 class="heading2" Style="font-size:17px;"><span>Kategori</span></h2>
...
<!--  <input list="producttype" name="producttype" style="width:60%;" class="controls">-->
         ...
         <h2 class="heading2" Style="font-size:17px;"><span>Filter Berdasarkan Produk</span></h2>
    ...
    <!--       <input list="brand" name="brand" style="width:60%;">-->  
       ...
       <form action="<?php echo site_url('tv/search/2/'.$var)?>" method="post"  name="brand"> 
           <div class="span3 " style="height:160px;"> 
          <div class="sidewidt">
            <h2 class="heading2" Style="font-size:17px;"><span>Filter Berdasarkan Brand </span></h2>
              ...
              <div class="span8">
               <!-- Sorting-->
                <div class=" well" style="height:60px;">
                   ...
                   <p style="color:#fe980f; font-weight:700; font-size:20px; text-align:center;">PRODUk</p>
                    ...
                    <li class="span2">
                      ...
                      <div class="thumbnail">
                        ...
                        <div class="pricetag" style="margin-left:-85px;">
                          ...
                          <a href="<?php echo site_url('tv/product/'.$productid)?>" class="" style="margin-right:-20px;">Tambah ke keranjang</a>
                          </div>
                        </div>
                      </div>
                    </li>
               ...
               <?php }?>  
                  ...
                  <input type="button" id="btnloadmore" value="Muat Lagi" onclick="loadmore()" class="btn btn-orange"  />
                  </div>
                 <div class="span3">
                  </div>
                  </div>
